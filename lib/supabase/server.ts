 ...
 * Route Handlers. Reads/writes the auth session via httpOnly cookies.
 *
      ...
      cookies: {
        ...
        setAll(cookiesToSet) {
          try {
            ...
            // (e.g. during a page render); this is safe to ignore as
            // long as middleware also refreshes the session.
          }
        },
      },
    },
